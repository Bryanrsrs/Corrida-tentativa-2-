class Game {
  ...
  start() {
    ...
    this.addSprites(combustiveis, 9, fuelImage, 0.02);
  ...
  showFuelBar() {
    ...
    fill("#ffc400");
    rect(width / 2 - 100, height - player.positionY - 280, player.combustivel, 20);
    noStroke();
    pop();
  }
